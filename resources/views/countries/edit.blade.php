        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('countries.update', $country->id) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="country_code" maxlength="3" type="text" class="form-control @error('country_code') is-invalid @enderror" name="country_code" value="{{ old('country_code', $country->country_code) }}" required autocomplete="country_code" autofocus>
